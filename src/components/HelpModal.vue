      ...
      <div class="w-full max-w-lg max-h-full h-auto bg-gray-100 rounded-sm p-4 overflow-auto" @click.stop="() => {}">
        <div class="flex flex-col">
          ...
          <div class="w-full mb-4">
            ...
            <p>Scoring works the same as Scrabble. Single letter bonuses are calculated before the word bonuses. Five letter words will receive a 10 point bonus after all other bonuses are calculated.</p>
          </div>
        </div>
      </div>
    </div>
